        ...
        Some(balance) => {
            if balance.amount < amount.amount.clone() + bridge_fee.amount.clone() {
                let error = if is_cosmos_originated {
                    format!("Your transfer of {} {} tokens is greater than your balance of {} tokens. Remember you need some to pay for fees!", print_atom(amount.amount), gravity_coin.denom, print_atom(balance.amount))
                } else {
                    format!("Your transfer of {} {} tokens is greater than your balance of {} tokens. Remember you need some to pay for fees!", print_eth(amount.amount), gravity_coin.denom, print_eth(balance.amount))
                };
